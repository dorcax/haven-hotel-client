    ...
    <>
      ...
      <main className="flex-1 flex overflow-hidden font-inter">
        <div className="flex w-full">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-20 bg-white">
            <div className="w-full max-w-[480px] flex flex-col">
              <div className="mb-10">
                <h2 className="text-[#1A365D] text-3xl font-bold mb-2">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-col gap-2">
                        <FormLabel className="text-slate-900 text-sm font-semibold">
                          Email Address
                        </FormLabel>
                        <FormControl>
                          <Input
                            className="form-input flex w-full rounded-lg text-slate-900 border border-slate-200 bg-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 text-base font-normal placeholder:text-slate-400"
                            type="email"
                      ...
                      <FormItem className="flex flex-col gap-2">
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input
                              className="form-input flex w-full rounded-lg text-slate-900 border border-slate-200 bg-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 text-base font-normal placeholder:text-slate-400 pr-12"
                              placeholder="••••••••"
