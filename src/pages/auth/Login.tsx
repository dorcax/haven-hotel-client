...
const Login = () => {
  ...
  return (
    <AuthLayout title="login to your account" description=" Enter your email and password to continue">
         <Form {...form}>
            <form
              action=""
          ...
          <article className="pt-6">
            ...
            <p className="text-sm pt-3 text-center text-[#6B7280]">
              ...
              <Link to="/" className="text-[#E3B23C] text-sm underline">SignUp</Link>
            </p>
          </article>
    </AuthLayout>
