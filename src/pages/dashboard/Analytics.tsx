    ...
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          ...
          <div
            key={i}
            className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm transition-all hover:shadow-md"
          >
      ...
      <div className="flex flex-col gap-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 flex flex-col gap-6 rounded-xl border border-[#cfdbe7] bg-white p-6 shadow-sm">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-[#0d141b]">
                  Revenue
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 rounded-xl border border-[#cfdbe7] bg-white p-6 shadow-sm">
            <div>
              <h3 className="text-[#0d141b] text-lg font-bold">
                Booking Volume
              </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-xl border border-[#cfdbe7] bg-white overflow-hidden shadow-sm">
            <div className="p-6 border-b border-[#cfdbe7] flex justify-between items-center">
              <h3 className="text-[#0d141b] text-lg font-bold">
                High-Value Bookings
              </h3>
            ...
            <div className="divide-y divide-[#cfdbe7]">
              <div className="px-6 py-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
                <div className="flex items-center gap-3">
                  <div
                    className="size-10 rounded-full bg-center bg-cover border-2 border-white shadow-sm"
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBtfrmNZkwFEJX3BTnmlZ_wJ9WM_pERySLE__xrcFK0CtwSYRZ6Y6RrdXlJKVoJLHQqH36HCaZXOJ_DicSlNXnK4FhI4hdWmDjAeHnkJ_j_xoskcHD41tAmwATotnq-_oBuiLt5nz3gV7qUyrpIcbhh1ikd8snisJZC7yNJ6JiHkC-rAGzZYplYNTbIA9MUODIkHQW4T1jpi9n9p9kKVeAq1JOYinKuTssDMmw_HvEBvLrpwCwkHxDO7oJ1N0k838cbq81iUseLiQ-2')",
                    }}
                  ></div>
                  <div>
              ...
              <div className="px-6 py-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAjBzdX-f_OtIJQDjD_ufgZdE0kyJGOkZLuccvOE_VqVab-cu4hm3JFdphMLcWsI8aMI4OdvRZ8T93CpwCf7wYUP0AlptX-XYD0j0CTGPfUhSnfA2xTFB5L5o738sY8z91oLsrAv2Rf1XpIQ3RMdn4ygZdgtvv2yH58a3RyUR_zqCUybTpTYh44h7qpv7upVgV2CZNcTicb2ewV62ryjdcFSqhCOV4DVuir8qzljrZbIgiGGT10wSn0fhdgazwSk5uTD6sztBQv_qxz')",
                    }}
                  ></div>
                  <div>
                    <p className="text-sm font-bold text-[#0d141b]">
          ...
          <div className="rounded-xl border border-[#cfdbe7] bg-white p-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-[#0d141b] text-lg font-bold">
                Peak Occupancy Times
              </h3>
              <span className="text-green-600 text-xs font-bold px-2 py-1 bg-green-100 rounded">
                Optimal Performance
              </span>
            </div>
            ...
            <div className="mt-6 p-4 rounded-lg bg-primary/5 border border-primary/10 flex gap-4">
              ...
              <p className="text-xs text-[#0d141b] font-medium leading-relaxed">
                <strong className="font-bold">Insight:</strong> Occupancy peaks
                on Thursdays. Consider dynamic pricing for weekend stays to
                balance mid-week volume.
              </p>
            </div>
          </div>
        </div>
