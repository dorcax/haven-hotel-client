...
const AddProperty = ({selectedType}:{selectedType:any}) => {
...
const{closeDialog} =usePopUpContext()
    ...
    return (
             ...
             <CustomInfoDialog
                  ...
                  >
                      <Form {...form}>
                    <form className=" grid grid-cols-3 gap-6 w-full " onSubmit={form.handleSubmit(onSubmit, (errors) => {
                        ...
                        <div className="py-4 col-span-1">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="capitalize text-base text-gray-900 pb-4">apartment image</FormLabel>
                        ...
                        <div className="space-y-4 py-4 col-span-2 ">
                            <h2 className="capitalize text-base text-gray-900 pb-4 ">apartment details</h2>
                            ...
                            <Button type="submit" className="w-full shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all capitalize">

                                {isLoading ? <Loader /> : "create apartment"}
                            </Button>
