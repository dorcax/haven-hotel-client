...
const Analytics = () => {
  return (
    <>
      <div className="border-b border-[#cfdbe7] flex gap-8 px-2">
        <button className="pb-4 pt-2 border-b-2 border-primary text-[#0d141b] text-sm font-bold">
          Daily View
        </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        <div className="lg:col-span-2 flex flex-col gap-6 rounded-xl border border-[#cfdbe7] bg-white p-6 shadow-sm">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-[#0d141b]">Revenue</span>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-6 rounded-xl border border-[#cfdbe7] bg-white p-6 shadow-sm">
          <div>
            <h3 className="text-[#0d141b] text-lg font-bold">Booking Volume</h3>
            <p className="text-[#4c739a] text-sm font-medium">
