  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        ...
        <p className="text-slate-500 text-sm font-medium">Loyalty Members</p>
        <p className="text-2xl font-black text-slate-900 mt-1">892</p>
      </div>
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <Calendar
            ...
            size={40}
          />
          <span className="text-slate-400 text-sm font-bold flex items-center bg-slate-50 px-2 py-1 rounded">
            Active
          </span>
        </div>
